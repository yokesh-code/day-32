    ...
    return (<>
        <div className="container">
            <div className="d-sm-flex align-items-center mt-3 justify-content-between mb-4">
                ...
                <Link to="/add-book" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    Add Book</Link>
            </div>
            {
                                    ...
                                    <tbody>
                                        {
                                            books.map((book, index) => {
                                                return <tr>
                                                    ...
                                                    <td>
                                                        <Link to={`/library/${book.id}`} className='btn btn-sm btn-success mr-2'>View</Link>

                                                        <Link to={`/library/edit/${book.id}`} className='btn btn-sm btn-primary mr-2'>Edit</Link>
